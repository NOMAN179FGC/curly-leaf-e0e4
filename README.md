...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-leaf-e0e4)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/curly-leaf-e0e4
```

A live public deployment of this template is available at [https://curly-leaf-e0e4.templates.workers.dev](https://curly-leaf-e0e4.templates.workers.dev)
